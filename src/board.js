...
function Board() {
  ...
  const[dRightDown,setDRightDown]=useState(false);
  const[dleftDown,setdleftDown]=useState(false);
  let myFilterdIds = [];
  console.log(count);
  ...
  const enableBlockDignolDownWardRight = () => {
                          let current_id = parseInt(getting_current_id) + 11;
                          let id = `${current_id}`;
                          // console.log(selectedBlocks);
                          // let arr = [...xAxis_Selection_Array_Right];
  ...
  const enableBlockDignolDownWardLeft = () => {
            let current_id = parseInt(getting_current_id) + 9;
            let id = `${current_id}`;
            // console.log(selectedBlocks);
            // let arr = [...xAxis_Selection_Array_Right];
              ...
              <NineBlock id={i}>
                {single_block_Into_Nine.map((s, j) => (
                  <Block
                    ...
                    dUpwardLeft={dUpwardLeft}
                    enableBlockDignolUpWardLeft={enableBlockDignolUpWardLeft}
                    dRightDown={dRightDown}
                    enableBlockDignolDownWardRight={enableBlockDignolDownWardRight}
                    dleftDown={dleftDown}
                    enableBlockDignolDownWardLeft={enableBlockDignolDownWardLeft}
