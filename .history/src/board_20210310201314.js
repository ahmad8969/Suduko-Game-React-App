...
//           const first = [completeArrayId];
// const second = [selectedId];
//
        ...
        //  let array1 = completeArrayId.filter(function(item) {
        //     return !selectedId.includes(item); 
        //   });
        //   console.log(array1);
        ...
        const changeStateHandler = (getting_current_id,Iid,Jid) => {
         ...
         if(Iid && Jid && getting_current_id !=null){
          ...
          removeCommon(complete_selection_array,complete_blocks_Array);
          // filter_two_arrays(complete_selection_array,complete_blocks_Array);
          // console.log(filter_two_arrays(complete_selection_array,complete_blocks_Array))
