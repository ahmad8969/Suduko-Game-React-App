...
function Board () {
  ...
  const DiagonalSelection = (z)=>{
    ...
    for( let ahmad = z; ahmad>=0; ahmad-=9){
        document.getElementById(ahmad).style.color="green";
    }

    //upward Diagonal Selection
    // let checkNumForIterationOfI = i;
    // let checkNumForIterationOfJ = j;

    // for( checkNumForIterationOfI; checkNumForIterationOfI<=0; checkNumForIterationOfI--){
    //     var one = checkNumForIterationOfI
    // }
    // for(checkNumForIterationOfJ; checkNumForIterationOfJ<=8; ++checkNumForIterationOfJ ){
    //     var two = checkNumForIterationOfJ;
  // }
  // let gettingUpDiagonalId = `${checkNumForIterationOfI}`+`${checkNumForIterationOfJ}`;
  //     console.log(gettingUpDiagonalId);

  // console.log(checkNumForIterationOfI,checkNumForIterationOfJ)
  }
