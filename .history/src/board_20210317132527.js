...
function Board() {
 ...
 console.log(count);
  ...
  const finalPath= (d)=>{
    let current_id=parseInt(d)+1;
    if(current_id===9||current_id===19||current_id===29||current_id===39||current_id===49||current_id===59||current_id===69||current_id===79||current_id===89||){
