...
function Board () {
  ...
  const [getting_current_id, setGetting_current_id]=useState('44');
  const [Iid, setIid]=useState('4');
  const [Jid, setJid]=useState('4');
  ...
  useEffect(
       function Click (idOfSpecificButton,i,j,e) {
      alert(idOfSpecificButton);
      alert(i);
      alert(j);
      // let buttoN = parseInt(idOfSpecificButton);
  ...
  ,[Click(idOfSpecificButton,i,j,e)]);
