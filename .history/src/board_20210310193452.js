      ...
      if(hello==0){
        ...
        const filter_two_arrays= (selectedId,completeArrayId)=> {
          ...
          const removeCommon = (complete_blocks_Array, complete_selection_array) => {
            const spreaded = [...complete_blocks_Array, ...complete_blocks_Array];
            return spreaded.filter(el => {
               return !(complete_blocks_Array.includes(el) && complete_blocks_Array.includes(el));
            })
         };
         console.log(removeCommon());


        //  let array1 = complete_blocks_Array.filter(function(item) {
