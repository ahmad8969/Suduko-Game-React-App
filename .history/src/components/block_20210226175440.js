...
const Block = (props) =>{
    var uniqueId1 = `${props.boardId}`+ `${props.keyId}` ;
    let[uniqueId1, setUniqueId1]= useState(props.number);
    ...
    return (
        <div className="button_block">
            <button id={pid} onClick={checkId} >{uniqueId1} </button>
