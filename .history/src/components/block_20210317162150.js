...
const Block = ({xAxisRight,xAxisleftPath,yAxisUpPath,yAxisDownPath,enableBlockDignolUpWardRight,left, right,Up,Down,dUpwardRight, keys, click, isclick, blockEnable}) => {
