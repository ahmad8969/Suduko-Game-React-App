  ...
  console.log(get_the_id_of_current_box); 
    for(let hello=get_the_id_of_current_box; hello<=88; hello+=array_of_length){
      if(hello==0){
       ...
       console.log(filter_two_arrays())
        const filter_two_arrays= (complete_blocks_Array,complete_selection_array)=> {
         
          // const removeCommon = (complete_blocks_Array, complete_selection_array) => {
            const spreaded = [...complete_blocks_Array, ...complete_selection_array];
            return spreaded.filter(el => {
               return !(complete_blocks_Array.includes(el) && complete_selection_array.includes(el));
            })
        //  };
        //  console.log(removeCommon());
