  ...
  console.log(get_the_id_of_current_box); 
    for(let hello=get_the_id_of_current_box; hello<=88; hello+=array_of_length){
      if(hello==0){
        ...
        // for(let checking_blocks_Id=0; checking_blocks_Id<=complete_blocks_Array.length; checking_blocks_Id++ ){
        //       if(complete_blocks_Array[checking_blocks_Id]==complete_selection_array[checking_blocks_Id]){
        //         // let checkId= complete_blocks_Array[checking_blocks_Id];
        //         console.log('a');
        //       }else{
        //         // let checkId1= complete_blocks_Array[checking_blocks_Id];
        //         console.log('b');
        //       }
        // }
        const filter_two_arrays =() =>{
          // let selectdIdArray = 0,
          //     completeArrayOfIdArray = 0;
